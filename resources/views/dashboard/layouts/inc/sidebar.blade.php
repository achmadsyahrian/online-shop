    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ Request::is('dashboard/best-products') ? 'active' : '' }}"
                        href="/dashboard/best-products" aria-expanded="false">
                        <span>
                            <i class="fa-regular fa-star"></i>
                        </span>
                        <span class="hide-menu">Best Products</span>
                    </a>
                </li>
                <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link " href="{{ route('tablewp') }}"
                        aria-expanded="false">
                        <span>
                            <i class="ti ti-files"></i>
                        </span>
                        <span class="hide-menu">Metode WP</span>
                    </a>
                </li>
                <li class="sidebar-item">

                    <a class="sidebar-link" href="{{ route('metodewp') }}"
                        aria-expanded="false">
                        <span>
                            <i class="ti ti-file"></i>
                        </span>
                        <span class="hide-menu">Detail Metode WP</span>
                    </a>
                </li>
