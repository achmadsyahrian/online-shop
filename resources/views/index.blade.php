    ...
    <div class="row no-gutters align-items-center pt-60px">
      ...
      <div class="col-sm-7 col-lg-6 offset-lg-1 pl-4 pl-md-5 pl-lg-0">
        <div class="hero-banner__content">
          ...
          <p>Selamat datang di toko online resmi kami, tempat di mana kepuasan Anda adalah prioritas utama kami.
            Jelajahi berbagai pilihan produk berkualitas tinggi, dari pakaian fashion hingga peralatan rumah tangga, dan
...
<section class="section-margin mt-0">
  <div class="owl-carousel owl-theme hero-carousel">
    ...
    <div class="hero-carousel__slide">
      <img src="{{ asset('storage/'. $product->photo_1) }}" style="height: 380px; object-fit:cover;" alt=""
        class="img-fluid">
        ...
        <div class="card text-center card-product">
          <div class="card-product__img">
            ...
            <ul class="card-product__imgOverlay">
              <li>
                <p class="card-product__price text-dark">Rp. {{ number_format($product->harga, 2, ',', '.') }}</p>
              </li>
            </ul>
          </div>
          <div class="card-body">
