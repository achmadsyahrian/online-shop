         ...
         <div class="row">
            <div class="col-lg-7">
               ...
               <form class="row contact_form" action="{{ route('transaction.add') }}" enctype="multipart/form-data"
                  ...
                  <textarea class="form-control" id="validationTextarea" name="alamat" placeholder="Alamat Lengkap">{{ old('description') }}</textarea>
            </div>
            <div class="col-lg-5">
               <div class="order_box">
                  <h2>Your Order</h2>
                  <ul class="list">
                     ...
                     <li>
                        <a>{{ Str::limit($product->name, 15) }} <span class="middle">x {{
                              ...
                              number_format($product->harga * $cart[$product->id]['quantity'], 2, ',', '.')
                              }}</span></a>
                     </li>
                     @php
                  ...
                  <div class="payment_item mt-4">
                     ...
                     <div class="radion_btn">
                        ...
                        <label class="@error('payment_method') text-danger @enderror" for="f-option5">
                           @error('payment_method') <i class="fa-solid fa-triangle-exclamation"></i> @enderror Bank
                           Transfer
                        </label>
                        <div class="check"></div>
                     </div>
