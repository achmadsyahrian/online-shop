      ...
      <div class="row s_product_inner">
         <div class="col-lg-6">
            ...
            {{-- <div class="owl-carousel owl-theme s_Product_carousel">
               ...
               @if ($product->photo_2)
               <div class="single-prd-item">
                  <img class="img-fluid" src="{{ asset('storage/'. $product->photo_2) }}"
                     style="width:537px; height:530px; object-fit:cover;" alt="">
               </div>
               @elseif($product->photo_3)
               <div class="single-prd-item">
                  <img class="img-fluid" src="{{ asset('storage/'. $product->photo_3) }}"
                     style="width:537px; height:530px; object-fit:cover;" alt="">
               </div>
               @endif
            </div> --}}
         ...
         <div class="col-lg-5 offset-lg-1">
            <div class="s_product_text">
               ...
               <ul class="list">
                  <li><a class="active" href="#"><span>Category</span> : {{ isset($product->category_id) ?
...
<section class="product_description_area">
   <div class="container">
      <ul class="nav nav-tabs" id="myTab" role="tablist">
         ...
         <li class="nav-item">
            <a class="nav-link" id="outlet-tab" data-toggle="tab" href="#outlet" role="tab" aria-controls="outlet"
               aria-selected="false">Outlet</a>
         </li>
      </ul>
         ...
         <div class="tab-pane fade " id="outlet" role="tabpanel" aria-labelledby="outlet-tab">
            ...
            <div class="comment_list mt-5">
               <div class="review_item">
                  ...
                  @else
                     <h6 class="text-center mt-4 text-secondary"><i class="fa-solid fa-circle-xmark "></i> No Description</h6>
                  @endif
               </div>
            </div>
         </div>
